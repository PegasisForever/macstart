...
const links = [
  ...
  new Link('main', 'Mcmaster University', 'https://www.mcmaster.ca/', null, 'The main website for the university.', 'COMMITTED TO CREATING A BRIGHTER WORLD'),
  ...
  new Link('linkedin-learning', 'Linkedin Learning', 'https://lnkd.in/gj-9Xgg', null, null, ''),
  new Link('zoom', 'Zoom', 'https://mcmaster.zoom.us/', null, null, ''),
  ...
  new Link('vmware-horizon', 'Virtual Desktop', 'https://virtualdesktop.cas.mcmaster.ca/', null, null),
  new Link('vena', 'Vena', 'https://vena.io/', null, null),
  ...
  new Link('mdprogram', 'MD Program', 'https://mdprogram.mcmaster.ca/', null, 'Michael G. DeGroote School of Medicine', 'The School of Medicine, established in 1966 and renamed the Michael G. DeGroote School of Medicine in 2004, offers major programs in undergraduate, postgraduate and graduate medical education.'),
  ...
  new Link('campusstore', 'Campus Store', 'https://campusstore.mcmaster.ca/', null, null, 'textbooks supplies clothing gifts health science technology general books faculty staff presto card'),
  ...
  new Link('mosaic', 'Mosaic', 'https://epprd.mcmaster.ca/psp/prepprd/?cmd=login', null, 'Access administrative information systems.'),
  new Link('iclicker', 'iClicker', 'https://student.iclicker.com/#/courses', null, 'Participate in class polls.'),
  new Link('email', 'Email', 'http://mail.mcmaster.ca/', null, 'You should check your inbox often.', 'outlook'),
  new Link('a2l', 'Avenue to Learn', 'https://avenue.mcmaster.ca/', null, 'Access course information.'),
  ...
  new Link('mcmaster-reddit', 'McMaster Subreddit', 'https://www.reddit.com/r/McMaster/', null, 'McMaster online community.'),
  new Link('teams', 'Microsoft Teams', 'https://teams.microsoft.com/', null, 'Join your virtual classes and connect to classmates.'),
  new Link('tophat', 'Top Hat', 'https://app.tophat.com/', null, 'Access your course materials'),
  new Link('pearson', 'My Pearson', 'https://portal.mypearson.com/', null, 'Access your course materials'),
  new Link('maccheck', 'MacCheck', 'https://maccheck.mcmaster.ca/', null, 'Daily covid check in.', 'covid-19 coronavirus'),
  new Link('hmdl', 'HMDL', 'https://courses.hayden-mcneil.com/', null, 'Online learning platform.'),
  ...
  new Link('msu', 'McMaster Student Union', 'https://msumcmaster.ca/', null, 'Advocating student interests.'),
  new Link('clubs', 'Clubs Directory', 'https://msumcmaster.ca/clubs/clubs-directory/', null, 'A list of all clubs in McMaster.'),
  new Link('opirg', 'OPIRG McMaster', 'https://www.opirgmcmaster.org/', null, 'Helping students organize around issues.'),
  new Link('marching', 'McMaster Marching Band', 'https://www.mcmastermarchingband.com/', null, null),
  ...
  new Link('cfmu', 'CFMU McMaster Community Radio', 'https://cfmu.ca/', null, null),
  new Link('msu-services', 'MSU Services', 'https://msumcmaster.ca/service/', null, 'A list of all the services MSU provides.'),
  new Link('ombuds', 'Ombuds Office', 'https://mcmaster.ca/ombuds/', null, 'Ensuring that students are treated fairly.'),
  new Link('silhouette', 'The Silhouette', 'https://www.thesil.ca/', null, 'McMaster’s student-run newspaper.'),
  new Link('underground-design', 'Underground Media + Design', 'https://undergrounddesign.ca/', null, 'Full-service media, design & print shop.'),
  new Link('fireball-academy', 'Fireball Academy', 'https://fireballacademy.mcmaster.ca/', null, 'Enhance your personal and professional skills.'),
  new Link('oscar', 'OSCARplus', 'https://www.oscarplusmcmaster.ca/home.htm', null, 'Find your coop opportunities.'),
  new Link('echo360', 'echo 360', 'https://echo360.ca/courses', null, 'Access your course materials'),
  new Link('mcmasterai', 'McMaster AI Society', 'https://www.mcmasterai.com/', null, 'Change the world with AI.'),
]
